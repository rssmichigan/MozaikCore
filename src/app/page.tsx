    ...
    <main className="min-h-screen bg-[radial-gradient(ellipse_at_top,rgba(0,0,0,0.03),transparent_60%)]">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <section className="py-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          <Feature title="Agents that remember"
                   desc="Mozaik stores your private context so answers improve over time." />
          <Feature title="Live export"
                   desc="Export runs as Markdown with one click for docs & sharing." />
          <Feature title="Production guardrails"
